defmodule ProjWeb.Router do
  ...
  import ProjWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ProjWeb.Layouts, :root}
  ...
  if Application.compile_env(:proj, :dev_routes) do
  ...
  scope "/", ProjWeb do
    ...
    live_session :current_user,
      on_mount: [{ProjWeb.UserAuth, :mount_current_user}] do
